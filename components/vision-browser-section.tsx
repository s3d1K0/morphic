...
interface VisionBrowserSectionProps {
  tool: ToolPart<'visionBrowser'>
  isOpen: boolean
...
export function VisionBrowserSection({
  tool,
  isOpen,
  onOpenChange,
  status,
...
export default VisionBrowserSection
